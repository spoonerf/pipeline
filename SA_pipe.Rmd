...
lapply(X = sp_names, background_sampler, in_dir = here::here("points/presence/"), out_dir = here::here("points/background/"), dens_abs = "density", density = 100, type = "background", buffer = 100, polygon = ecoreg)

lapply(X = sp_names, background_sampler, in_dir = here::here("points/presence/"), out_dir = here::here("points/pseudoabsence/"), dens_abs = "density", density = 100, type = "pseudoabsence", buffer = 100, polygon = ecoreg)
...
ps_ex_in_files <- list.files(here::here("points/pseudoabsence/"),
                             pattern = "*.csv",
                             full.names = TRUE)

ps_ex_out_files <-
  paste0(here::here("environmental/pseudoabsence/"),
         "/",
         basename(ps_ex_in_files))

mapply(ras_extract, in_file = ps_ex_in_files, out_file = ps_ex_out_files)

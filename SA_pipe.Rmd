...
lapply(
  ...
  predictor_names = c(1, 5, 6, 12, 13, 14),
  predictors = env_crop,
...
lapply(
  X = sp_names[11:length(sp_names)],
  fitGLM,
  pres_dir = here::here("environmental/presence"),
  backg_dir = here::here("environmental/pseudoabsence/"),
  predictor_names = c(1, 5, 6, 12, 13, 14),   #need to think about which ones we want to include
  predictors = env_crop,

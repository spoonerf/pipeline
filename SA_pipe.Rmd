...
background_sampler(sp_name = sp_name, in_dir = here::here("points/presence/"), out_dir = here::here("points/background/"), dens_abs = "density", density = 10, type = "pseudoabsence", buffer = 100, polygon = ecoreg)

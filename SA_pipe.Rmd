...
lapply(X= sp_names[1:10], FUN = ras_extract,in_dir = here::here("points/presence/"), out_dir = here::here("environmental/presence/"))
...
lapply(X = sp_names[1:10], background_sampler, in_dir = here::here("points/presence/"), out_dir = here::here("points/background/"), dens_abs = "density", density = 100, type = "background",  polygon = ecoreg)

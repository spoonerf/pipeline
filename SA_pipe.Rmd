...
```{r, Loading and cropping the environmental data, cache=TRUE}
...
#   dir.create(here::here("points/background/"), recursive = TRUE)
# }
# 
# lapply(X = sp_names, background_sampler, in_dir = here::here("points/rarefied/"), out_dir = here::here("points/background/"), dens_abs = "density", density = 250, type = "background", polygon = ecoreg)
...
lapply(
  ...
  pres_dir = here::here("environmental/presence"),
  backg_dir = here::here("environmental/pseudoabsence/"),
  predictor_names = c(1, 3, 4, 12),   #need to think about which ones we want to include
  predictors = env_crop,

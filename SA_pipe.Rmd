...
ras_extract <- function(occ_file, out_file) {
  df <- vroom::vroom(occ_file)
...
mapply(ras_extract, occ_file = occ_files, out_file = out_files)
...
out_files <- paste0(here::here("environmental/background/"),
         "/",
         basename(occ_files))


bg_out <- mapply(background_sampler, occ_file = occ_files ,no_pnts = 10000, out_file = out_files)
# 
